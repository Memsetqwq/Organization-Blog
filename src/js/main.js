...
const T={
  zh:{
    ...
    event4Date:'2026.04.04',event4Meta:'近期活动 / 能力认证',
    event5t:'腾讯云社区龙虾公开课',event5d:'社团社长陈圣夫以核心导师身份进行WorkBuddy实战演示，将开源社区的协作理念传递给更多开发者。',
    event5Date:'2026.03.24',event5Meta:'近期活动 / 技术分享',
    ...
    followLabel:'关注我们',
    navAbout:'关于我们',navTech:'技术方向',navEvents:'近期活动',navMembers:'核心成员',navProjects:'开源项目',
  ...
  en:{
    ...
    event4Date:'2026.04.04',event4Meta:'Recent / Certification',
    event5t:'Tencent Cloud Course',event5d:'President Chen demonstrated WorkBuddy as core instructor.',
    event5Date:'2026.03.24',event5Meta:'Recent / Tech Sharing',
