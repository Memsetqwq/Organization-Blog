...
| 特性 | v0.1 | v0.2-v0.4 | v0.5-v0.6 | v0.7-v0.8 | v0.9 | v1.0 | v1.1 |
|-----|------|-----------|-----------|-----------|------|------|------|
| 布局 | 三栏 | 全屏分栏 | 全屏分栏 | 全屏分栏 | 全屏分栏 | 全屏分栏 | 多页面 |
| 动画 | Shader | 滚动渐入 | 滚动渐入+主题动画 | 双向滚动动画 | 双向动画 | 双向动画 | 双向动画 |
| 主题 | 手动 | 系统跟随 | 太阳/月亮按钮 | 亮/暗切换 | 亮/暗切换 | 亮/暗切换 | 亮/暗切换 |
| 构建 | ❌ | ❌ | Parcel | Parcel | Parcel | Parcel | Parcel |
| 申请管理 | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | ✅ |
| CI/CD | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ |
| 多页面 | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ |
